                  ...
                  <div className="slider-images slider-images-consoles">
                    <Link to={"/ps5red"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1596" alt="Call-of-duty" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                            <p>SONY PLAYSTATION 5 OFFICIAL DUAL SENSE CONTROLLER COSMIC RED (PRE-OWNED)</p>
                          </div>
                    ...
                    <Link to={"/vr2"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_3884" alt="last-of-us" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/edge"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_4051" alt="gta-v" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/movemotion"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1073" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/logitech"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1076" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/xboxpulse"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1437" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/xboxdaystrike"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1511" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/xboxjoy"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1151" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/xboxneonblue"} className='transform'>
                      <div className="product-first">
                        <div className="product-name">
                          <p>Pre Owned</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_1152" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                    ...
                    <Link to={"/nintendodock"} className='transform'>
                      <div className="product-first">
                        <div className="product-name new-product-name">
                          <p>New</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_3132" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
                            <p>NINTENDO SWITCH DOCK-NINTENDO SWITCH (PRE-OWNED)</p>
                          </div>
                          <div className="product-card d-flex justify-content-between mt-2">
                            <div className="product-price">
                              <div className="price-display">
                    ...
                    <Link to={"/oculus"} className='transform'>
                      <div className="product-first">
                        <div className="product-name new-product-name">
                          <p>New</p>
                          <img src="https://sgp1.digitaloceanspaces.com/relay-bl-in-records/GameNation/EA_3321" alt="ghost" width={'135px'} height={'170px'}/>
                        </div>
                        <div className="product-info">
                          <div className="product-text">
